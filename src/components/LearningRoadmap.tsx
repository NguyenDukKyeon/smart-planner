...
export function LearningRoadmap({
  ...
  const dynamicMilestones = useMemo<DynamicMilestone[]>(() => {
    const lessonsWithDate = activeLessons.map((l) => {
      // Match the flexible plan instead of grouping every imported lesson into
      // its original/default week. Completed lessons keep their completion date;
      // remaining lessons use the latest shifted date generated by the planner.
      const effectiveDate = completed[l.id]
        ? completed[l.id]
        : (shiftedDates[l.id] ?? l.scheduledDate);
