...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/icons/app-icon-square.svg?v=2", type: "image/svg+xml" },
      { rel: "shortcut icon", href: "/icons/app-icon-square.svg?v=2", type: "image/svg+xml" },
      { rel: "manifest", href: "/manifest.webmanifest?v=4" },
      { rel: "apple-touch-icon", href: "/icons/app-icon-square.svg?v=2" },
    ],
  }),
