...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#1858f5" },
    ...
    links: [
      ...
      { rel: "icon", href: "/icons/app-icon-square.svg?v=1", type: "image/svg+xml" },
      { rel: "shortcut icon", href: "/icons/app-icon-square.svg?v=1", type: "image/svg+xml" },
      { rel: "manifest", href: "/manifest.webmanifest?v=3" },
      { rel: "apple-touch-icon", href: "/icons/app-icon-square.svg?v=1" },
    ],
  }),
