...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/icons/app-icon.svg?v=1", type: "image/svg+xml" },
      { rel: "shortcut icon", href: "/icons/app-icon.svg?v=1", type: "image/svg+xml" },
      { rel: "manifest", href: "/manifest.webmanifest?v=2" },
      { rel: "apple-touch-icon", href: "/icons/app-icon.svg?v=1" },
    ],
  }),
